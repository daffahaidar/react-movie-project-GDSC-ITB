      ...
      <>
              <div className = "Navbar">
                  <ul>
                      ...
                      <li>
                        <a onClick={() => navigateTo('movies')} className = "ActivedHome">Beranda</a>
                      </li>
                      <li>
                        <a onClick={() => navigateTo('wishlist')} className="WLButton">Favorit ({wishlist.length})</a>
                      </li>
                  </ul>
              </div>
              <div className="Cards">
    ...
    const renderWishlist = () => (
      ...
      <div className = "Navbar">
                  <ul>
                      ...
                      <li>
                        <a onClick={() => navigateTo('movies')} className = "Home">Beranda</a>
                      </li>
                      <li>
                        <a onClick={() => navigateTo('wishlist')} className="ActivedWL">Favorit ({wishlist.length})</a>
                      </li>
                  </ul>
      </div>
              ...
              {wishlist.map((movie, idx) => (
                <div className = "WishlistCard">
                  ...
                  <div className = "RemoveButton">
                    <h5 onClick={() => removeFromWL(movie)}>Hapus</h5>
                  </div>
                </div>
              ))}
            </div>
